...
class LoginPanel extends JPanel {
  ...
  private static class GradientPanel extends JPanel {
    ...
    GradientPanel() {
      ...
      // Load the UB logo
      try {
        logoImage = javax.imageio.ImageIO.read(new java.io.File("src/images/ublogo.png"));
      } catch (java.io.IOException e) {
        System.err.println("Could not load UB logo: " + e.getMessage());
      }
    }
    ...
    protected void paintComponent(Graphics g) {
      ...
      // Draw logo at the top if loaded
      if (logoImage != null) {
        int logoWidth = 120;
        int logoHeight = (logoImage.getHeight(null) * logoWidth) / logoImage.getWidth(null);
        int logoX = (getWidth() - logoWidth) / 2;
        g2.drawImage(logoImage, logoX, 30, logoWidth, logoHeight, this);
      }

      g2.setColor(Color.WHITE);
      g2.setFont(UITheme.TITLE_FONT);
      int textY = logoImage != null ? 200 : 80;
      
      String title = "University of Baguio";
      int titleWidth = g2.getFontMetrics().stringWidth(title);
      g2.drawString(title, (getWidth() - titleWidth) / 2, textY);
      
      g2.setFont(UITheme.SECTION_FONT);
      String subtitle = "Visitor Security Portal";
      int subtitleWidth = g2.getFontMetrics().stringWidth(subtitle);
      g2.drawString(subtitle, (getWidth() - subtitleWidth) / 2, textY + 40);
      
      g2.setFont(UITheme.BODY_FONT);
      String line1 = "Monitor guests, secure campuses,";
      int line1Width = g2.getFontMetrics().stringWidth(line1);
      g2.drawString(line1, (getWidth() - line1Width) / 2, textY + 90);
      
      String line2 = "and empower your team in one hub.";
      int line2Width = g2.getFontMetrics().stringWidth(line2);
      g2.drawString(line2, (getWidth() - line2Width) / 2, textY + 114);
    }
  }
}
