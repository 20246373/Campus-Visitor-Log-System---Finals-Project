...
class GuardDashboardPanel extends JPanel {
  ...
  GuardDashboardPanel(GuardDirectory guardDirectory, AdminDirectory adminDirectory, VisitorTableModel visitorTableModel) {
    ...
    logPanel = new VisitorLogPanel(visitorTableModel, guardDirectory.getGuards(), adminDirectory.getAdmins(), false);
